...
const pageTitle = ref('Landivisiau'); // Browser tab title
...
Bonjour,<p> pour mieux connaître les usagers de la gare de Landivisiau,<p>la Communauté de Communes du Pays de Landivisiau<p> la Région Bretagne et la SNCF souhaiteraient en savoir plus sur votre déplacement en cours.<p> Auriez-vous quelques secondes à nous accorder ?
